...
async def makeBody() -> Dict[str, str]:
    ...
    try:
      ...
      if True:
        template_filepath: str = getEnvironment("GITHUB_ACTION_PATH") + "/render_templates/body_templates/drink_template_file"
        with open(template_filepath, "r") as file:
          body_specific_dictionary["drink"] = render(file, drink)

      if True:
        template_filepath: str = getEnvironment("GITHUB_ACTION_PATH") + "/render_templates/body_templates/profile_template_file"
        with open(template_filepath, "r") as file:
          body_specific_dictionary["profile"] = render(file, body_specific_dictionary)

      if True:
        template_filepath: str = getEnvironment("GITHUB_ACTION_PATH") + "/render_templates/body_templates/animals_template_file"
        with open(template_filepath, "r") as file:
          body_specific_dictionary["animals"] = render(file, animals)
      
      if len(wakatime_api_key) > 0:
        waka = await getWakaStats()
        template_filepath: str = getEnvironment("GITHUB_ACTION_PATH") + "/render_templates/body_templates/stats_template_file"
        with open(template_filepath, "r") as file:
      ...
      if len(nasa_api_key) > 0:
        ...
        template_filepath: str = getEnvironment("GITHUB_ACTION_PATH") + "/render_templates/body_templates/nasa_template_file"
        with open(template_filepath, "r") as file:
          body_specific_dictionary["nasa"] = render(file, nasa)
        
      if len(feed_url) > 0:
        template_filepath: str = getEnvironment("GITHUB_ACTION_PATH") + "/render_templates/body_templates/feed_template_file"
        with open(template_filepath, "r") as file:
          body_specific_dictionary["feed"] = render(file, feed)

      template_filepath: str =  getEnvironment("GITHUB_ACTION_PATH") + "/render_templates/body_template_file"
      with open(template_filepath, "r") as file:
...
<p align="center">"""
 ...
 <img src=\"{webpage_qr}\">
    ...
    template_filepath: str = getEnvironment("GITHUB_ACTION_PATH") + "/render_templates/footer_template_file"
    with open(template_filepath, "r") as file:
